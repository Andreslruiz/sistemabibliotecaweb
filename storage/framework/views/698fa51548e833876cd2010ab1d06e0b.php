                            ...
                            <img src="https://www.iudigital.edu.co/Style%20Library/images/logo-escudo.png" width="120" height="40" class="d-inline-block align-top" alt="">
                                ...
                                <ul class="navbar-nav mr-auto">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item" href="<?php echo e(route('libros.create')); ?>">Registrar Libro</a>
                                        <a class="dropdown-item" href="<?php echo e(route('autors.create')); ?>">Registrar Autor</a>
                                        <a class="dropdown-item" href="<?php echo e(route('editorials.create')); ?>">Registrar Editorial</a>
                                    </div>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                    <a class="nav-link" href="<?php echo e(route('autors.index')); ?>">Autores</a>
                                    </li>
                                    <li class="nav-item">
                                    <a class="nav-link" href="<?php echo e(route('editorials.index')); ?>">Editoriales</a>
                                    </li>
                                </ul>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\andre\SistemaDeBibliotecaWeb\resources\views/home.blade.php ENDPATH**/ ?>